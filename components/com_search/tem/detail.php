                ...
                <div class="content">
                    <div class="row row_26">
                        ...
                        <div class="col-sm-8 column-right">
                            ...
                            if($obj->Num_rows()>0){
                                echo '<div class="box-related"><div class="title-box"><div class="inline">Bài viết cùng chuyên mục</div></div><ul class="list-related">';
                                while ($row_related = $obj->Fetch_Assoc()) {
                                    $link_related = ROOTHOST.'tro-giup/'.$row_related['code'].'.html';
