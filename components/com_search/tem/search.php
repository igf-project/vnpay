...
<div class="page page-list-help">
	<div class="page-header">
		<img src="<?php echo ROOTHOST;?>images/root/banner-help.jpg" class="img-responsive">
		<div class="container">
			<div class="h1">
				<ul class="breadcrumb">
					<li><a href="<?php echo ROOTHOST;?>tro-giup">TRỢ GIÚP</a></li>
					<li><a href="<?php echo ROOTHOST;?>tro-giup/tim-kiem">TÌM KIẾM</a></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="box-contents">
				<div class="row row_26">
					...
					<div class="col-sm-8 column-right">
						<h1 class="h1_search">Kết quả tìm kiếm của từ khóa <font color="red">"<?php echo $keywork;?>"</font></h1>
						<div class="form-search-help">
							<form id="form_search_help" name="frm-search" method="get" action="<?php echo ROOTHOST;?>tro-giup/tim-kiem">
								<input type="hidden" name="q" value="<?php echo $keywork;?>">
								<div class="form-group">
									<div class="input-group">
										<input type="text" id="ip_search_help" name="" class="form-control input-lg" placeholder="Tìm kiếm trợ giúp" required>
										<div class="input-group-btn"><button class="btn btn-lg">Tìm kiếm</button></div>
									</div>
								</div>
							</form>
						</div>
						<div class="box-list-help">
							...
							if($total_rows>0){
								...
								while ($row=$obj->Fetch_Assoc()) {
									...
									$link = ROOTHOST.'tro-giup/'.$code.'.html';
