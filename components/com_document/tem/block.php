...
if(isset($_GET['code'])){
    ...
    $link_cate = ROOTHOST.LINK_DOCUMENT.'/'.$info_cate['code'].'-'.$info_cate['doctype_id'];
    $strWhere=" AND type_id = ".$info_cate['doctype_id'];
}
?>
                    ...
                    <div class="row row_26">
                        <div id="col-left" class="col-sm-4">
                            ...
                            while ($row_cate = $obj_cate->Fetch_Assoc()) {
                                ...
                                if($codeCate==$getCode){
                                    echo '<li class="list-group-item select"><i class="fa fa-circle" aria-hidden="true"></i>';
