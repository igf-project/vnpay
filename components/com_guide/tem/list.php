...
<div class="page page-list-help">
    <div class="page-header">
        ...
        <div class="container">
            <div class="h1">
                <ul class="breadcrumb">
                    <li><a href="<?php echo ROOTHOST.LINK_HELP;?>" title="<?php echo HELP ?>"><?php echo HELP ?></a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="content">
                <div class="row row_26">
                    ...
                    <div class="col-sm-8 column-right">
                        <div class="row_26 box_link_doc_question">
                            <div class="col-sm-6 column-left"><a href="<?php echo ROOTHOST;?>tai-lieu" title="<?php echo DOCUMENT ?>"><?php echo DOCUMENT ?></a></div>
                            <div class="col-sm-6 column-right"><a href="<?php echo ROOTHOST;?>hoi-dap" title="<?php echo HELP ?>"><?php echo HELP ?></a></div>
                        </div>
