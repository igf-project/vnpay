...
class CLS_MODULE{
	...
	public function Add_new(){
		$sql='INSERT INTO `tbl_modules` (`type`,`viewtitle`,`mnu_id`,`cate_id`,`cate_service_id`,`gdoc_id`,`cate_intro_id`,`cate_guide_id`,`theme`,`position`,`class`,`isactive`) VALUES ';
		$sql.="('".$this->pro['Type']."','".$this->pro['ViewTitle']."','".$this->pro['MnuID']."','".$this->pro['Cate_ID']."','".$this->pro['Cate_Service_ID']."','".$this->pro['Gdoc_ID']."','".$this->pro['Cate_Intro_ID']."','".$this->pro['Cate_Guide_ID']."','".$this->pro['Theme']."','".$this->pro['Position']."','".$this->pro['Class']."','".$this->pro['isActive']."')";
		// echo $sql;
	...
	function Update(){
		...
		`cate_service_id`='".$this->pro['Cate_Service_ID']."',
		`gdoc_id`='".$this->pro['Gdoc_ID']."',
		`cate_intro_id`='".$this->pro['Cate_Intro_ID']."',
		`cate_guide_id`='".$this->pro['Cate_Guide_ID']."',
