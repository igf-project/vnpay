...
define('COMS','cate_guide');
require_once('libs/cls.cate_guide.php');
require_once('libs/cls.guide.php');
$title_manager="Danh sách trợ giúp";
if(isset($_GET['task']) && $_GET['task']=='add')
	$title_manager = "Thêm mới nhóm trợ giúp";
if(isset($_GET['task']) && $_GET['task']=='edit')
	$title_manager = "Sửa nhóm trợ giúp";

$objCon=new CLS_GUIDE();
...
if(isset($_POST['cmdsave'])){
	...
	echo "<script language=\"javascript\">window.location.href='".ROOTHOST_ADMIN."guide'</script>";
}
if(isset($_POST["txtaction"]) && $_POST["txtaction"]!=""){
	...
	echo "<script language=\"javascript\">window.location='".ROOTHOST_ADMIN."guide'</script>";
}
