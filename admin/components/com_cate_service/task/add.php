...
<div class="body">
    ...
    <div class='col-md-3'>
        <div class='row body_col_left bleft bright'>
            <div class="com_header color">
                <i class="fa fa-sitemap" aria-hidden="true"></i> Nhóm SP & DV
            </div>
    ...
    <div class='col-md-9 body_col_right'>
        <div class='row'>
            <div class="com_header color">
                <i class="fa fa-list" aria-hidden="true"></i> Thêm mới nhóm SP & DV
                <div class="pull-right">
                    <form id="frm_menu" name="frm_menu" method="post" action="">
                        ...
                        <ul class="list-inline">
                            ...
                            <li><a class="btn btn-default"  href="<?php echo ROOTHOST_ADMIN;?>service" title="Đóng"><i class="fa fa-sign-out" aria-hidden="true"></i> Đóng</a></li>
                        </ul>
                    </form>
                </div>
            </div>
