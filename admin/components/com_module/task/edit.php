...
<div class="body">
    ...
    <div class='row'>
        <div class="com_header color">
            <i class="fa fa-list" aria-hidden="true"></i> Sửa Module
    ...
    <form id="frm_action" name="frm_action" method="post" action="">
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <script type="text/javascript">
                                cbo_Selected('cbo_cate_service','<?php echo $row['gdoc_id'];?>');
                                $(document).ready(function() {
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="col-sm-3 form-control-label">Nhóm hỏi đáp</label>
                        <div class="col-sm-9">
