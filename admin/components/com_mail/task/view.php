<?php include_once("extensions/function.php");
...
<div class='row'>
	<div class="com_header color">
		<i class="fa fa-list" aria-hidden="true"></i>  Chi tiết thư
		<div class="pull-right">
			<a href="<?php echo ROOTHOST_ADMIN;?>mail"><button class="btn btn-default">
