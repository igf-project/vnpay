...
if($id==0 && isset($_SESSION['QUESTION_ID_SELECTED'])){
	$id=(int)$_SESSION['QUESTION_ID_SELECTED'];
	$group_name=addslashes($_SESSION['QUESTION_ID_SELECTED']);
}
?>
<div class="body">
	<div class='col-md-3'>
		<div class='row body_col_left bleft bright'>
			<div class="com_header color">
				<i class="fa fa-sitemap" aria-hidden="true"></i> Nhóm hỏi đáp
			</div>
			<div class='user_group_list'><?php $obj_gquestion->getListCategory();?></div>
...
<script>
	...
	function getUserByGroup(gid,name){
		...
		window.location="<?php echo ROOTHOST_ADMIN;?>question/cate_intro/"+gid;
	}
	function group_edit(){
