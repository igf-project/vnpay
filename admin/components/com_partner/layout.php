...
if($id==0 && isset($_SESSION['PARTNER_ID_SELECTED'])){
	$id=(int)$_SESSION['PARTNER_ID_SELECTED'];
	...
	<div class='col-md-3'>
		<div class='row body_col_left bleft bright'>
			<div class="com_header color">
				<i class="fa fa-sitemap" aria-hidden="true"></i> Nhóm đối tác
			</div>
...
<script>
	...
	function getUserByGroup(gid,name){
		...
		window.location="<?php echo ROOTHOST_ADMIN;?>partner/cate_intro/"+gid;
	}
	function group_edit(){
