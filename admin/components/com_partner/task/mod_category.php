...
<div class='user_group_func'>
	<ul class='nav'>
		<li class='cmd_group_add'><a href='<?php echo ROOTHOST_ADMIN;?>cate_partner/add' class='cgreen'><i class="fa fa-user-plus" aria-hidden="true"></i> Thêm mới</a></li>
		<?php
		if($cate_id>0){
			echo '<li class="cmd_group_edit"><a href="'.ROOTHOST_ADMIN.'cate_partner/edit/'.$cate_id.'" ><i class="fa fa-edit" aria-hidden="true"></i> Sửa nhóm</a></li>';
			echo '<li class="cmd_group_del"><a href="'.ROOTHOST_ADMIN.'cate_partner/delete/'.$cate_id.'" class="cred" onclick="return confirm(\'Bạn có chắc muốn xóa?\')"><i class="fa fa-user-times" aria-hidden="true"></i> Xóa nhóm</a></li>';
		}else{
