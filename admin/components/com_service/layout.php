...
if($id==0 && isset($_SESSION['SERVICE_ID_SELECTED'])){
	$id=(int)$_SESSION['SERVICE_ID_SELECTED'];
...
<script>
	...
	function getUserByGroup(gid,name){
		...
		window.location="<?php echo ROOTHOST_ADMIN;?>service/cate_intro/"+gid;
	}
	function group_edit(){
