...
$obj_cate=new CLS_CATEGORY_INTRO;
...
if($id==0 && isset($_SESSION['INTROID_SELECTED'])){
	$id=(int)$_SESSION['INTROID_SELECTED'];
	...
	<div class='col-md-3'>
		<div class='row body_col_left bleft bright'>
			<div class="com_header color">
				<i class="fa fa-sitemap" aria-hidden="true"></i> Giới thiệu
			</div>
...
<script>
	...
	function getUserByGroup(gid,name){
		...
		window.location="<?php echo ROOTHOST_ADMIN;?>intro/cate_intro/"+gid;
	}
	function group_edit(){
