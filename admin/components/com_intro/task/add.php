...
<div class='row'>
    <div class="com_header color">
        <i class="fa fa-list" aria-hidden="true"></i> Thêm mới bài giới thiệu
    ...
    <form id="frm_action" class="form-horizontal" name="frm_action" method="post" enctype="multipart/form-data">
        <div class="tab-content">
            <div class="tab-pane fade active in" id="info">
                ...
                <label class="col-sm-3 col-md-2 control-label">Nhóm <span class="cred">*</span></label>
                ...
                <div class="clearfix"></div>
                <div class="form-group">
                    <label class="col-sm-3"> Tóm tắt</label>
                    <div class="col-md-12">
...
<script type="text/javascript">
    var ComponentsEditors = function () {
        ...
        var handleSummernote = function () {
            $('#txt_intro').summernote({height: 120});
            $('#txt_fulltext').summernote({height: 400});
        }
        return {
