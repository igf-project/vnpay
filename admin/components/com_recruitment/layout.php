...
if($id==0 && isset($_SESSION['RECUITMENT_ID_SELECTED'])){
	$id=(int)$_SESSION['RECUITMENT_ID_SELECTED'];
	$group_name=addslashes($_SESSION['INTRONAME_SELECTED']);
}
?>
<div class="body">
	<div class='col-md-3'>
...
<script>
	...
	function getUserByGroup(gid,name){
		...
		window.location="<?php echo ROOTHOST_ADMIN;?>recruitment/cate_intro/"+gid;
	}
	function group_edit(){
