    ...
    function checkinput(){
        if($("#txt_name").val()==""){
            $("#txt_name_err").fadeTo(200,0.1,function(){
                $(this).html('Vui lòng nhập tên bài tuyển dụng').fadeTo(900,1);
            });
            $("#txt_name").focus();
            return false;
        }
...
<div class='row'>
    <div class="com_header color">
        <i class="fa fa-list" aria-hidden="true"></i> Thêm mới bài tuyển dụng
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="info">
                <div class="form-group">
                    <label class="col-sm-3 col-md-2 control-label">Nhóm tuyển dụng <span class="cred">*</span></label>
            ...
            <div class="tab-pane fade" id="seo">
                <div class='form-group'>
                    <label class="col-sm-3 control-label">Mô tả tiêu đề</label>
                    <div class="col-sm-9">
