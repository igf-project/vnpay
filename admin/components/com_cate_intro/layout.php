...
if(isset($_POST['cmdsave'])){
	...
	echo "<script language=\"javascript\">window.location.href='".ROOTHOST_ADMIN."intro'</script>";
}
if(isset($_POST["txtaction"]) && $_POST["txtaction"]!=""){
	...
	echo "<script language=\"javascript\">window.location='".ROOTHOST_ADMIN."intro'</script>";
}
