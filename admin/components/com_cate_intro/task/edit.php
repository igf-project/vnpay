...
<div class="body">
    ...
    <div class='col-md-3'>
        <div class='row body_col_left bleft bright'>
            <div class="com_header color">
                <i class="fa fa-sitemap" aria-hidden="true"></i> <a href="<?php echo ROOTHOST_ADMIN.COMS?>" title="Tin tức">Nhóm bài viết giới thiệu</a>
            </div>
    ...
    <div class='col-md-9 body_col_right'>
        <div class='row'>
            <div class="com_header color">
                <i class="fa fa-list" aria-hidden="true"></i> Sửa nhóm bài viết giới thiệu
                    ...
                    <div id="menus" class="toolbars">
                        <form id="frm_menu" name="frm_menu" method="post" action="">
                            ...
                            <ul class="list-inline">
                                ...
                                <li><a class="btn btn-default"  href="<?php echo ROOTHOST_ADMIN;?>intro" title="Đóng"><i class="fa fa-sign-out" aria-hidden="true"></i> Đóng</a></li>
                            </ul>
                        </form>
                    </div>
                </div>
