...
$title_manager="Danh sách nhóm hỏi đáp";
if(isset($_GET['task']) && $_GET['task']=='add')
	$title_manager = "Thêm mới nhóm hỏi đáp";
if(isset($_GET['task']) && $_GET['task']=='edit')
	$title_manager = "Sửa nhóm hỏi đáp";
...
if(isset($_POST['cmdsave'])){
	...
	echo "<script language=\"javascript\">window.location.href='".ROOTHOST_ADMIN."question'</script>";
}
if(isset($_POST["txtaction"]) && $_POST["txtaction"]!=""){
	...
	echo "<script language=\"javascript\">window.location='".ROOTHOST_ADMIN."question'</script>";
}
