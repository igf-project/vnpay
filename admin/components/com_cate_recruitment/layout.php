...
define('COMS','cate_recruitment');
require_once('libs/cls.cate_recruitment.php');
require_once('libs/cls.recruitment.php');
$title_manager="Danh sách nhóm tuyển dụng";
if(isset($_GET['task']) && $_GET['task']=='add')
	$title_manager = "Thêm mới nhóm tuyển dụng";
if(isset($_GET['task']) && $_GET['task']=='edit')
	$title_manager = "Sửa nhóm tuyển dụng";

$objCon=new CLS_RECRUITMENT();
...
if(isset($_POST['cmdsave'])){
	...
	echo "<script language=\"javascript\">window.location.href='".ROOTHOST_ADMIN."recruitment'</script>";
}
if(isset($_POST["txtaction"]) && $_POST["txtaction"]!=""){
	...
	echo "<script language=\"javascript\">window.location='".ROOTHOST_ADMIN."recruitment'</script>";
}
